      ...
      <div className="ticket-column">
        <h3 className="column-top">
          ...
          <div className="column-icon">
              ...
              {columnTitle === "Todo" && <img src={todoicon} />}
              {columnTitle === "In Progress" && <img src={inprogicon} />}
              {columnTitle === "Completed" && <img src={doneicon} />}
              {columnTitle === "Cancelled" && <img src={cancelledicon} />}
            </div>
          <div>{columnTitle}</div>
        ...
        {groupedTickets.map((ticket) => (
          <div key={ticket.id} className="ticket-card">
            ...
            <div className="cards">
            <div className="card-feature"><img src={threedot}></img></div>
